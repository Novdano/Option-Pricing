...
## R Markdown
```{r}
df_atm <- read.csv(file="C:/Users/Novdano/Desktop/SURF/Option-Pricing/AAPL_Data/AAPL_3M_Call_K195_T210619.csv")
df_stock <- read.csv(file="C:/Users/Novdano/Desktop/SURF/Option-Pricing/AAPL_Data/AAPL_3M_Stock.csv")
S_0 <- df_stock[1,3]
C_0 <- df_atm[4,5]
